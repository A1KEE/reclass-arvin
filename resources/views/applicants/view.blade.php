...
<input type="hidden" id="isViewMode" value="1">
 ...
 <div id="ppst-container">
    @include('applicants.ppst-final-table', [
  ...
  <table class="table table-bordered align-middle text-center">
    ...
    <tbody>
      <tr>
        ...
        <td><input type="number" name="comparative[performance]" id="performanceFinal" class="form-control form-control-sm text-center" value="{{ $application->scores->performance_points ?? 0 }}" readonly></td>
        <td><input type="number" name="comparative[coi_score]" class="form-control form-control-sm text-center" value="{{ $application->scores->coi_score ?? 0 }}" readonly></td>
        <td><input type="number" name="comparative[ncoi_score]" class="form-control form-control-sm text-center" value="{{ $application->scores->ncoi_score ?? 0 }}" readonly></td>
        <td><input type="number" name="comparative[bei_score]" class="form-control form-control-sm text-center" value="{{ $application->scores->bei_score ?? 0 }}" readonly></td>
...
<div class="table-responsive mb-4">
  <table class="table table-bordered align-middle text-center">
    ...
    <tbody>
      <tr>
        <td>Reclassification of Position</td>
        <td><input type="text" name="regional[from_position]" class="form-control form-control-sm" readonly></td>
        <td><input type="text" name="regional[from_grade]" class="form-control form-control-sm"readonly></td>
        <td><input type="text" name="regional[to_position]" class="form-control form-control-sm" readonly></td>
        <td><input type="text" name="regional[to_grade]" class="form-control form-control-sm" readonly></td>
        <td><input type="date" name="regional[date_processed]" class="form-control form-control-sm" readonly></td>
        <td><input type="text" name="regional[remarks]" class="form-control form-control-sm" readonly></td>
      </tr>
    </tbody>
  </table>
</div>
