            ...
            <div class="experience-summary-sticky">
              ...
              <div id="experience_summary_modal">
                <div class="alert bg-light-green border-light-green mb-0 p-3">
                  ...
                  Required Years:
                  <span id="required_exp_years_display">0</span><br>

                  Current Total:
                  <span id="total_exp_years_display">0</span><br>

                  Status:
                  <span class="text-muted">No experiences added</span><br>

                  Score:
                  <span id="qsPoints" class="fw-bold text-muted">
                    Waiting for input (0–10 points)
                  </span>
                </div>
              </div>
